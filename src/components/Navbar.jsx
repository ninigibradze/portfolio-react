...
export const Navbar = () => {
  ...
  const mailtoHref =
    "mailto:ninigibradze@gmail.com?subject=SendMail&body=Description";
    ...
    >
      ...
      <ul
        className={
          !nav
            ? "hidden"
            : `absolute top-0 left-0 w-full h-screen bg-[#0a192f] flex flex-col
        ...
        <ul>
          ...
          >
            <a
              ...
              href="https://www.linkedin.com/in/nini-gibradze"
              target="_blank"
              rel="noreferrer"
            >
          ...
          >
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/ninigibradze"
              target="_blank"
              rel="noreferrer"
            >
          ...
          >
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="Nino Gibradze_Resume.pdf"
              download="Nino Gibradze_Resume.pdf"
            >
